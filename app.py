...
def exibir_opcoes():
    print('1. Cadastrar restaurante', '2. Listar restaurantes', 
          '3. Alternar estado do restaurante', '4. Sair', sep='\n')
...
def escolher_opcao():
    ...
    # We also could use the 'match' instruction to do so. For instance:
    '''
